...
if (process.env.NODE_ENV === 'production') {
    ...
    app.use(express_1.default.static(path_1.default.join(__dirname, 'react-movie-db/build')));
    //Express will serve up the index.html file if it doesn't recognize the route
    app.get('*', function (req, res) {
        res.sendFile(path_1.default.resolve(__dirname, 'react-movie-db', 'build', 'index.html'));
    });
}
exports.default = app;
